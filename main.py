...
@bot.command()
async def tips(ctx):
    await ctx.send(f'Tips Untuk Mengatasi Polusi: 1. Meminimalisir menggunakan kendaraan pribadi 2. Memilah sampah organik menjadi pupuk dan mendaur ulang sampah plastik 3. Mengurangi penggunaan kendaraan yang sudah tidak layak pakai 4. Berjalan kaki ketika jarak yang ditempuh dekat')
# rolling dice
@bot.command()
async def dice(ctx):
...
async def mem(ctx):
    ...
    with open(f'meme/meme_1.jpg', 'rb') as f:
